...
subfile = strcat([folder,'sub_gamma_h20_hetero_Lf_eve',num2str(nnum),'.txt']);
...
plot(data(:,2),data(:,1),'^k','markerfacecolor','k');
plot(data(:,3),data(:,1),'-^','markerfacecolor',[232 67 106]/255,'color',[232 67 106]/255);
